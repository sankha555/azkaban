...
//        }
	...
	// 	printf("=========================================== RELU ========================================\n");
	// 	printf("Lower Expression:\n");
	// 	for(i=0; i < num_in_neurons; i++){
	// 		int num_coeffs = in_neurons[i]->lexpr->size;
	// 		printf("N%d: ", i+1);
	// 		for(int j = 0; j < num_coeffs; j++){
	// 			printf("%f ", in_neurons[i]->lexpr->sup_coeff[j]);
	// 		}

	// 		printf("%f ", in_neurons[i]->lexpr->sup_cst);
	// 		// expr_print(in_neurons[i]->lexpr);
	// 		printf("\n");
	// 	}
	// 	printf("\n\n");

	// 	printf("Upper Expression:\n");
	// 	for(i=0; i < num_in_neurons; i++){
	// 		int num_coeffs = in_neurons[i]->uexpr->size;
	// 		printf("N%d: ", i+1);
	// 		for(int j = 0; j < num_coeffs; j++){
	// 			printf("%f ", in_neurons[i]->uexpr->sup_coeff[j]);
	// 		}
	// 		printf("%f ", in_neurons[i]->uexpr->sup_cst);
	...
	// printf("Lower Bounds:\n");
    // for(i=0; i < num_out_neurons; i++){
	// 	int num_coeffs = out_neurons[i]->lexpr->size;
	// 	printf("%f ", out_neurons[i]->lb);
    // }
	// printf("\n");

	// printf("Upper Bounds:\n");
    // for(i=0; i < num_out_neurons; i++){
	// 	int num_coeffs = out_neurons[i]->uexpr->size;
	// 	printf("%f ", out_neurons[i]->ub);
    // }
	// printf("\n");
	...
	// 	printf("N%d: ", i+1);
	// 	for(int j = 0; j < num_coeffs; j++){
	// 		printf("%f ", out_neurons[i]->lexpr->sup_coeff[j]);
	// 	}
	...
	// 	printf("N%d: ", i+1);
	// 	for(int j = 0; j < num_coeffs; j++){
	// 		printf("%f ", out_neurons[i]->uexpr->sup_coeff[j]);
	// 	}
	// 	// expr_print(out_neurons[i]->lexpr);
	// 	printf("\n");
    // }
	...
	// printf("Lower Expression:\n");
	// for(i=0; i < num_out_neurons; i++){
	// 	int num_coeffs = out_neurons[i]->backsubstituted_lexpr->size;
	// 	printf("N%d: ", i+1);
	// 	for(int j = 0; j < num_coeffs; j++){
	// 		printf("%f ", out_neurons[i]->backsubstituted_lexpr->sup_coeff[j]);
	// 	}
	// 	printf("%f ", out_neurons[i]->backsubstituted_lexpr->sup_cst);
	// 	// expr_print(out_neurons[i]->lexpr);
	// 	printf("\n");
	// }
	// printf("\n\n");
	...
	// printf("Upper Expression:\n");
	// for(i=0; i < num_out_neurons; i++){
	// 	int num_coeffs = out_neurons[i]->backsubstituted_uexpr->size;
	// 	printf("N%d: ", i+1);
	// 	for(int j = 0; j < num_coeffs; j++){
	// 		printf("%f ", out_neurons[i]->backsubstituted_uexpr->sup_coeff[j]);
	// 	}
	// 	printf("%f ", out_neurons[i]->backsubstituted_uexpr->sup_cst);
	// 	// expr_print(out_neurons[i]->lexpr);
	// 	printf("\n");
	// }
	// printf("==========================================================================================\n\n\n");
...
void handle_convolutional_layer(elina_manager_t* man, elina_abstract0_t* element, double *filter_weights, double * filter_bias,  
	...
	// input_size[2] = in_channels
	// input_size[0], [1] = h, w
	// output_size[2] = out_channels
	...
	for(out_x=0; out_x < output_size[0]; out_x++) {
	    for(out_y = 0; out_y < output_size[1]; out_y++) {
		 for(out_z=0; out_z < output_size[2]; out_z++) {
			...
			// printf("neuron %zu: ", mat_x);
			// for(int j = 0; j < actual_coeff; j++){
			// 	printf("%f ", out_neurons[mat_x]->lexpr->sup_coeff[j]);
			// }
			// printf("\n");
